...
<Project Type="Project" LVVersion="17008000">
	...
	<Property Name="varPersistentID:{75C6A7F9-96CA-46A7-A283-8374E9B89F54}" Type="Ref">/myRIO-1900/variables.lvlib/pwm</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Controls" Type="Folder">
			<Item Name="MainControl.ctl" Type="VI" URL="../Controls/MainControl.ctl"/>
		</Item>
		<Item Name="GUI" Type="Folder">
			<Item Name="GUI" Type="Folder">
				<Item Name="Color control Folder" Type="Folder">
					<Item Name="Color control.vi" Type="VI" URL="../GUI/GUI/Color control Folder/Color control.vi"/>
				</Item>
				<Item Name="Captura VI.PNG" Type="Document" URL="../GUI/GUI/Captura VI.PNG"/>
				<Item Name="conveyor bandBCF.png" Type="Document" URL="../GUI/GUI/conveyor bandBCF.png"/>
				<Item Name="conveyor whith backg.png" Type="Document" URL="../GUI/GUI/conveyor whith backg.png"/>
				<Item Name="INT IDI.JPG" Type="Document" URL="../GUI/GUI/INT IDI.JPG"/>
				<Item Name="Interfaz Barra de Carga B.png" Type="Document" URL="../GUI/GUI/Interfaz Barra de Carga B.png"/>
				<Item Name="Interfaz Barra de Carga.png" Type="Document" URL="../GUI/GUI/Interfaz Barra de Carga.png"/>
				<Item Name="Interfaz de autenticación.png" Type="Document" URL="../GUI/GUI/Interfaz de autenticación.png"/>
				<Item Name="Interfaz Tabs y simulación - colores, etc..png" Type="Document" URL="../GUI/GUI/Interfaz Tabs y simulación - colores, etc..png"/>
				<Item Name="Interfaz Tabs y simulación B.png" Type="Document" URL="../GUI/GUI/Interfaz Tabs y simulación B.png"/>
			</Item>
		</Item>
		<Item Name="SubVI" Type="Folder">
			<Item Name="Autentication" Type="Folder">
				<Item Name="Control" Type="Folder">
					<Item Name="Enum_Autenticacion.ctl" Type="VI" URL="../SubVI/Autentication/Control/Enum_Autenticacion.ctl"/>
				</Item>
				<Item Name="Persistencia" Type="Folder">
					<Item Name="Danilo.lvm" Type="Document" URL="../SubVI/Autentication/Persistencia/Danilo.lvm"/>
					<Item Name="David.lvm" Type="Document" URL="../SubVI/Autentication/Persistencia/David.lvm"/>
					<Item Name="Diego.lvm" Type="Document" URL="../SubVI/Autentication/Persistencia/Diego.lvm"/>
					<Item Name="Mauricio.lvm" Type="Document" URL="../SubVI/Autentication/Persistencia/Mauricio.lvm"/>
				</Item>
				<Item Name="Autenticacion.vi" Type="VI" URL="../SubVI/Autentication/Autenticacion.vi"/>
			</Item>
			<Item Name="Color" Type="Folder">
				<Item Name="BD" Type="Folder">
					<Item Name="Danilo.lvm" Type="Document" URL="../SubVI/Color/BD/Danilo.lvm"/>
					<Item Name="David.lvm" Type="Document" URL="../SubVI/Color/BD/David.lvm"/>
					<Item Name="Diego.lvm" Type="Document" URL="../SubVI/Color/BD/Diego.lvm"/>
					<Item Name="Mauricio.lvm" Type="Document" URL="../SubVI/Color/BD/Mauricio.lvm"/>
				</Item>
				<Item Name="Control" Type="Folder">
					<Item Name="ColorTypeEnum.ctl" Type="VI" URL="../SubVI/Color/Control/ColorTypeEnum.ctl"/>
					<Item Name="EnumControl.ctl" Type="VI" URL="../SubVI/Color/Control/EnumControl.ctl"/>
				</Item>
				<Item Name="GuardarColor.vi" Type="VI" URL="../SubVI/Color/GuardarColor.vi"/>
			</Item>
			<Item Name="Reconocimiento-de-Voz" Type="Folder">
				<Item Name="DB" Type="Folder">
					<Item Name="Danilo.wav" Type="Document" URL="../SubVI/Reconocimiento-de-Voz/DB/Danilo.wav"/>
					<Item Name="David.wav" Type="Document" URL="../SubVI/Reconocimiento-de-Voz/DB/David.wav"/>
					<Item Name="Diego.wav" Type="Document" URL="../SubVI/Reconocimiento-de-Voz/DB/Diego.wav"/>
					<Item Name="Mauricio.wav" Type="Document" URL="../SubVI/Reconocimiento-de-Voz/DB/Mauricio.wav"/>
				</Item>
				<Item Name="SubVi" Type="Folder">
					<Item Name="RemoveOrGetExt.vi" Type="VI" URL="../SubVI/Reconocimiento-de-Voz/SubVi/RemoveOrGetExt.vi"/>
				</Item>
				<Item Name="Nicolas.wav" Type="Document" URL="../SubVI/Reconocimiento-de-Voz/Nicolas.wav"/>
				<Item Name="ReconocimientoVoz (SubVI).vi" Type="VI" URL="../SubVI/Reconocimiento-de-Voz/ReconocimientoVoz (SubVI).vi"/>
				<Item Name="Wilmer.wav" Type="Document" URL="../SubVI/Reconocimiento-de-Voz/Wilmer.wav"/>
			</Item>
			<Item Name="Simulation" Type="Folder">
				<Item Name="Control" Type="Folder">
					<Item Name="SimulationColorTypeEnum.ctl" Type="VI" URL="../SubVI/Simulation/Control/SimulationColorTypeEnum.ctl"/>
					<Item Name="SimulationMainEnum.ctl" Type="VI" URL="../SubVI/Simulation/Control/SimulationMainEnum.ctl"/>
				</Item>
				<Item Name="Simulation.vi" Type="VI" URL="../SubVI/Simulation/Simulation.vi"/>
			</Item>
		</Item>
		<Item Name="Enum_GuardarColores.ctl" Type="VI" URL="../SubVI/Autentication/Control/Enum_GuardarColores.ctl"/>
		<Item Name="GuardarColores.vi" Type="VI" URL="../SubVI/Autentication/GuardarColores.vi"/>
		<Item Name="ProyectoFinalArduino.vi" Type="VI" URL="../ProyectoFinalArduino.vi"/>
...
AddOutputFilter chunkFilter
		...
		<Item Name="PWM_Motor.vi" Type="VI" URL="../PWM_Motor.vi"/>
